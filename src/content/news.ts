...
export const newsSection = {
  title: 'News',
  description:
    'Gelegentliche Notizen zu Architektur, Context Engineering und Analyse mit KI — ohne Hype-Takt.',
  intro: {
    title: 'Was hier landet',
    paragraphs: [
      'Ab und zu etwas zu Formaten, Agenten-Workflows und Dokumentationsmodellen, die in Projekten wirklich vorkommen.',
      'Kein regelmäßiger Blog. Jeder Text beschreibt eine Technik oder ein Artefaktmodell — und wo sinnvoll, wie das bei AGM und E2 aussieht.',
    ],
  },
} as const;
...
export const newsArticles: readonly NewsArticle[] = [
  {
    ...
    paragraphs: [
      ...
      'AGM adressiert die Architekturseite: ein repo-lokaler Markdown-Linkgraph unter docs/architecture/, orchestriert über blueprint.md, traversierbar statt RAG. Architekturdokumentation wird zur API der KI-Konversation.',
      'E2 adressiert die Fachseite: Event Storming, DDD, BDD/Example Mapping, User Story Mapping und Event Modeling auf einem Board. Das Ergebnis ist kein Screenshot, sondern eine schema-konforme .storm.json (board-snapshot-v1) mit Elementen, Relationen, optionalen Event-Schemas, Glossary und Hotspots.',
      ...
      'Praktischer Pfad: Workshop → Board modellieren → .storm.json exportieren → in der IDE als zusätzlichen Agenten-Input referenzieren („Implementiere Aggregate X gemäß Board“). Optional danach AGM für Ist/Soll-Architektur und iterative Umsetzung.',
      'Zur Einordnung: Das Tool allein ist austauschbar. Wert entsteht durch Facilitation, ein geprüftes Schema-Deliverable und die Anbindung an Agenten-Workflows — einzeln oder zusammen mit AGM.',
    ],
  },
  {
    slug: 'zwei-monate-okf-einordnung-aus-projekten',
    date: '2026-07-08',
    title: 'Zwei Monate OKF — was man in Projekten sieht',
    excerpt:
      'Zwei Monate nach der Veröffentlichung des Open Knowledge Format: Interchange-Format ja, Methodikersatz nein.',
    ...
    paragraphs: [
      ...
      'Nach zwei Monaten: OKF eignet sich als Exchange- und Exportformat zwischen Katalogen und Repos. Wer Context Engineering braucht, braucht darüber hinaus Graph-Disziplin, Work-Register und Verify-Schritte — unabhängig davon, ob die Dateien OKF-konform sind.',
    ],
  },
  {
    ...
    paragraphs: [
      ...
      '11 — Retrieval Stack: RAG als Ergänzungsschicht für Exploration; Graph-Traversierung für strukturelle Architekturfragen. Beides kann koexistieren — mit klarer Priorität, welches Wissen verbindlich ist.',
      ...
      'Kurz: Die Prinzipien sind tooling-neutral. AGM deckt einen Teil davon konkret ab (Graph, blueprint.md, Verify, CI); Sandboxing, Trajectory Review und Policy-Hooks bleiben außerhalb der Methode und gehören zum umgebenden Agenten-Setup.',
    ],
  },
  {
  ...
  },
  {
    ...
    excerpt:
      'Unterschied zwischen RAG-basierten Chat-Kontexten und Markdown-Linkgraphen für Architekturfragen — und wo AGM einsetzt.',
    ...
    paragraphs: [
      ...
      'Eine Alternative ist ein repo-lokaler Dokumentationsgraph: Markdown-Dateien mit expliziten Links, versioniert in Git. Agenten traversieren die Kanten statt per Embedding-Ähnlichkeit. Jede Aussage bleibt an eine Datei und oft an Code-Evidenz gebunden.',
      'AGM setzt genau dieses Modell um: Graph unter docs/architecture/, Orchestrierung über blueprint.md, Navigation ab entry-point.md, Vertiefung in work/-Reports. KI füllt und aktualisiert den Graph; Menschen prüfen. Review-Workflows laufen report-only in separaten Chats.',
